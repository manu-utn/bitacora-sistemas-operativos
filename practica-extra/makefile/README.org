...
** Macros automáticas
*** Conceptos
    Las *macros automáticas* son macros *internas* cuyo valor depende de la regla
    que esstemos ejecutando.
    ...
    |-------+--------------------------------------------------------------------|
    | $?    | Lista de los archivos de dependencias ás recientes que el target   |
